...
export default registerBlockType("jsforwphowto/donation", {
  title: __("Membership Benefits", "jsforwphowto"),
  description: __(
    "Add the membership benefits copy to a donation page.",
    "jsforwphowto"
  ),
  category: "common",
  icon: {
  ...
  keywords: [__("Membership Benefits", "jsforwphowto")],
  attributes: {
    checkboxControl: {
      type: "boolean",
      default: true,
    ...
    return (
      <>
        <InspectorControls>
          <PanelBody>
            <CheckboxControl
              label={__("Show Magazine Offer", "jsforwpblocks")}
              help={__(
