...
<html class="no-js" <?php language_attributes(); ?>>
  ...
  <div class="collapse navbar-collapse ml-auto justify-content-end" id="navbarNavAltMarkup">
    <div class="navbar-nav ml-auto justify-content-end">
      ...
      <a class="nav-item nav-link text-nowrap" href="/stories-and-updates/">Secular Rescue Stories</a>
      <a class="nav-item nav-link text-nowrap" href="/blasphemy-rights-day/">Blasphemy Rights Day</a>
      <a class="nav-item nav-link text-nowrap" href="/get-help/">Get Help</a>
    </div>
  </div>
</nav>
