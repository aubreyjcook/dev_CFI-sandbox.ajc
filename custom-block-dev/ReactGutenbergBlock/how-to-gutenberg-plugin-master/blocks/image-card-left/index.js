 ...
 * Register block
 */
export default registerBlockType("jsforwphowto/image-card-left", {
  title: __("Image Card Left", "jsforwphowto"),
    ...
    return [
      ...
      <>
        <div
          id={anchor}
          className={
            "card white-card-shadow image-card-left mt-3 mb-3 clearfix " +
            className
          }
        >
          {!imgID ? (
            ...
            <>
              <div class="wp-block-cover left-card-image border-0">
                <a href={url}>
                  <img
                    loading="lazy"
  ...
  save: (props) => {
    ...
    return (
      <>
        ...
        >
          {imgURL && (
            <div className="wp-block-cover left-card-image border-0">
              <a href={url}>
                <img
                  loading="lazy"
                  className="wp-block-cover__image-background"
