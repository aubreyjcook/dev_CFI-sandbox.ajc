 ...
 * Register block
 */
export default registerBlockType("jsforwphowto/highlight", {
  title: __("Highlight", "jsforwphowto"),
  description: __(
    "Highlight a program with the logo and more information.",
    "jsforwphowto"
  ),
  category: "common",
  icon: {
  ...
  keywords: [__("Program", "jsforwphowto")],
  attributes: {
    imgURL: {
      type: "string",
      source: "attribute",
      attribute: "src",
      selector: ".program-image img",
    },
    imgID: {
      type: "number",
    },
  ...
  edit: (props) => {
    ...
    return [
      <InspectorControls>
        <PanelBody>
          <TextControl
            label={__("Logo Link", "jsforwphowto")}
            value={url}
      ...
      <>
        <div
          id={anchor}
          className={"program-list clearfix mt-3 mb-3 " + className}
        ...
        >
          {!imgID ? (
            ...
            <>
              <div class="wp-block-cover program-image border-0">
                <a href={url}>
                  <img
                    loading="lazy"
  ...
  save: (props) => {
    ...
    return (
      <>
        ...
        >
          {imgURL && (
            <div className="wp-block-cover program-image border-0">
              <a href={url}>
                <img
                  loading="lazy"
                  className="wp-block-cover__image-background"
